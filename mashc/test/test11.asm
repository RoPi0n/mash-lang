...
word vtable__fakevoice 12
word vtable__add 13
word vtable__insert 14
word vtable__delete 15
word vtable__clear 16
word vtable__get 17
word vtable__indexof 18
word vtable__count 19
word vtable__sort 20
word vtable__find 21
word vtable__nextins 22
word vtable__lock 23
word vtable__unlock 24
word vtable__normvideo 25
word vtable__wherex 26
word vtable__wherey 27
word vtable__pause 28
word vtable__cursorbig 29
word vtable__cursoroff 30
word vtable__cursoron 31
word vtable__delline 32
word vtable__gotoxy 33
word vtable__insline 34
word vtable__keypressed 35
word vtable__readkey 36
word vtable__sound 37
word vtable__window32 38
word vtable__clreol 39
word vtable__clrscr 40
word vtable__getdirectvideo 41
word vtable__getlastmode 42
word vtable__settextattr 43
word vtable__gettextattr 44
word vtable__getwindmax 45
word vtable__getwindmaxx 46
word vtable__getwindmaxy 47
word vtable__getwindmin 48
word vtable__getwindminx 49
word vtable__getwindminy 50
word vtable__getcheckbreak 51
word vtable__getcheckeof 52
word vtable__getchecksnow 53
word vtable__textcolor 54
word vtable__textbackground 55
word vtable__push 56
word vtable__peek 57
word vtable__pop 58
...
pushc eunderflow
swp
word generator.const.gcn.29 8
pushcp generator.const.gcn.29
swp
peekai
peek emathexception
pop
word generator.const.gcn.30 3
...
pop
str generator.const.gcn.36 "Unknown raised exception."
...
pop
str generator.const.gcn.40 "hrhrhrhrhhr"
...
pop
str generator.const.gcn.42 "Moooo..."
...
pop
str generator.const.gcn.44 "mew :3"
...
jr
cat__voice__end:
pushcp cat__fakevoice__end
jp
cat__fakevoice:
@cat__fakevoice.this
push global.this
peek cat__fakevoice.this
pop
str generator.const.gcn.46 "FUUUCK"
pushc generator.const.gcn.46
push cat__fakevoice.this
peek global.this
pushc vtable__say
swp
pushai
...
pcopy
peek global.this
str generator.const.gcn.50 "Bob"
...
pcopy
peek global.this
str generator.const.gcn.53 "Bill"
...
pcopy
peek global.this
str generator.const.gcn.56 "Joseph"
...
pcopy
peek global.this
str generator.const.gcn.59 "Kail"
...
pcopy
peek global.this
str generator.const.gcn.62 "Robert"
...
peek main.x
pop
push structure_instance_cat
peek global.this
pushc vtable__fakevoice
swp
pushai
push main.x
peek global.this
...
pcopy
peek global.this
str generator.const.gcn.75 ") out of bounds."
pushc generator.const.gcn.75
push list__insert.index
str generator.const.gcn.76 "List index ("
...
pop
pushcp generator.if.gcn.81.else
...
pcopy
peek global.this
str generator.const.gcn.84 ") out of bounds."
pushc generator.const.gcn.84
push list__delete.index
str generator.const.gcn.85 "List index ("
...
pushc global.raised
trr
pushcp generator.if.gcn.81.end
jp
generator.if.gcn.81.else:
push list__delete.this
peek global.this
pushc vtable__size
swp
...
pushai
pushc setlen
word generator.const.gcn.88 2
pushcp generator.const.gcn.88
push global.arg_counter
mov
jc
generator.if.gcn.81.end:
jr
list__delete__end:
...
pop
generator.while.gcn.99.start:
pushcp generator.while.gcn.99.end
...
jz
pop
pushcp generator.if.gcn.100.else
push list__indexof.this
peek global.this
pushc vtable__items
swp
...
push list__indexof.i
jr
generator.if.gcn.100.else:
push list__indexof.i
inc
pop
pushcp generator.while.gcn.99.start
jp
generator.while.gcn.99.end:
...
peek list__indexof.i
pop
generator.while.gcn.102.start:
pushcp generator.while.gcn.102.end
push list__indexof.this
peek global.this
pushc vtable__size
swp
...
inc
pop
pushcp generator.while.gcn.102.start
jp
generator.while.gcn.102.end:
...
pushai
pushc binnext
word generator.const.gcn.107 2
...
peek __printarray.i
pop
generator.while.gcn.144.start:
pushcp generator.while.gcn.144.end
push __printarray.l
push __printarray.i
swp
bg
...
pop
pushcp generator.if.gcn.146.else
push __printarray.l
...
jz
pop
str generator.const.gcn.148 ", "
pushc generator.const.gcn.148
pushc _print
invoke
generator.if.gcn.146.else:
push __printarray.i
inc
pop
pushcp generator.while.gcn.144.start
jp
generator.while.gcn.144.end:
...
swp
jz
str generator.const.gcn.153 "(null)"
pushc generator.const.gcn.153
pushc _print
invoke
pushcp generator.switch.gcn.150.end
jp
...
swp
pushai
str generator.const.gcn.157 "> with message: '"
...
swp
pushai
str generator.const.gcn.158 "Exception <"
...
pushc _print
invoke
pushcp generator.if.gcn.155.end
jp
...
pcopy
peek global.this
str generator.const.gcn.160 "I/O exception: invalid object type for output"
...
peek print.args
pop
@generator.for_each.gcn.164.array
@generator.for_each.gcn.164.i
@generator.for_each.gcn.164.to
push print.args
peek generator.for_each.gcn.164.array
alen
peek generator.for_each.gcn.164.to
pop
pushc global.zero
peek generator.for_each.gcn.164.i
pop
generator.for_each.gcn.164.start:
pushcp generator.for_each.gcn.164.end
push generator.for_each.gcn.164.i
push generator.for_each.gcn.164.to
eq
not
jz
pop
push generator.for_each.gcn.164.i
push generator.for_each.gcn.164.array
pushai
@print.arg
peek print.arg
pop
...
mov
jc
generator.for_each.gcn.164.continue:
push generator.for_each.gcn.164.i
inc
pop
pushcp generator.for_each.gcn.164.start
jp
generator.for_each.gcn.164.end:
jr
print__end:
pushcp println__end
jp
...
peek println.args
pop
@generator.for_each.gcn.167.array
@generator.for_each.gcn.167.i
@generator.for_each.gcn.167.to
push println.args
peek generator.for_each.gcn.167.array
alen
peek generator.for_each.gcn.167.to
pop
pushc global.zero
peek generator.for_each.gcn.167.i
pop
generator.for_each.gcn.167.start:
pushcp generator.for_each.gcn.167.end
push generator.for_each.gcn.167.i
push generator.for_each.gcn.167.to
eq
not
jz
pop
push generator.for_each.gcn.167.i
push generator.for_each.gcn.167.array
pushai
@println.arg
peek println.arg
pop
...
mov
jc
generator.for_each.gcn.167.continue:
push generator.for_each.gcn.167.i
inc
pop
pushcp generator.for_each.gcn.167.start
jp
generator.for_each.gcn.167.end:
str generator.const.gcn.169 ""
...
pop
word generator.const.gcn.170 7
...
pop
word generator.const.gcn.172 256
...
pop
word generator.const.gcn.173 256
...
pop
pushcp generator.if.gcn.174.end
jp
...
pop
word generator.const.gcn.178 0
...
pop
generator.while.gcn.180.start:
pushcp generator.while.gcn.180.end
push system_op_range.l
...
inc
pop
pushcp generator.if.gcn.182.else
push system_op_range.isback
jz
pop
...
push system_op_range.j
mov
pushcp generator.if.gcn.182.end
jp
generator.if.gcn.182.else:
...
push system_op_range.j
mov
generator.if.gcn.182.end:
pushcp generator.while.gcn.180.start
jp
generator.while.gcn.180.end:
push system_op_range.res
jr
jr
...
pop
@generator.for_each.gcn.185.array
@generator.for_each.gcn.185.i
@generator.for_each.gcn.185.to
push system_op_in.right
peek generator.for_each.gcn.185.array
alen
peek generator.for_each.gcn.185.to
pop
pushc global.zero
peek generator.for_each.gcn.185.i
pop
generator.for_each.gcn.185.start:
pushcp generator.for_each.gcn.185.end
push generator.for_each.gcn.185.i
push generator.for_each.gcn.185.to
eq
not
jz
pop
push generator.for_each.gcn.185.i
push generator.for_each.gcn.185.array
pushai
@system_op_in.x
peek system_op_in.x
pop
...
generator.for_each.gcn.185.continue:
push generator.for_each.gcn.185.i
inc
pop
pushcp generator.for_each.gcn.185.start
jp
generator.for_each.gcn.185.end:
pushc false
jr
jr
system_op_in__end:
...
peek max.r
pop
@generator.for_each.gcn.204.array
@generator.for_each.gcn.204.i
@generator.for_each.gcn.204.to
push max.args
peek generator.for_each.gcn.204.array
alen
peek generator.for_each.gcn.204.to
pop
pushc global.zero
peek generator.for_each.gcn.204.i
pop
generator.for_each.gcn.204.start:
pushcp generator.for_each.gcn.204.end
push generator.for_each.gcn.204.i
push generator.for_each.gcn.204.to
eq
not
jz
pop
push generator.for_each.gcn.204.i
push generator.for_each.gcn.204.array
pushai
@max.x
peek max.x
pop
...
generator.for_each.gcn.204.continue:
push generator.for_each.gcn.204.i
inc
pop
pushcp generator.for_each.gcn.204.start
jp
generator.for_each.gcn.204.end:
push max.r
jr
pushcp generator.if.gcn.200.end
jp
generator.if.gcn.200.else:
push null
jr
generator.if.gcn.200.end:
jr
max__end:
pushcp min__end
jp
...
peek min.args
pop
pushcp generator.if.gcn.207.else
...
peek min.r
pop
@generator.for_each.gcn.211.array
@generator.for_each.gcn.211.i
@generator.for_each.gcn.211.to
push min.args
peek generator.for_each.gcn.211.array
alen
peek generator.for_each.gcn.211.to
pop
pushc global.zero
peek generator.for_each.gcn.211.i
pop
generator.for_each.gcn.211.start:
pushcp generator.for_each.gcn.211.end
push generator.for_each.gcn.211.i
push generator.for_each.gcn.211.to
eq
not
jz
pop
push generator.for_each.gcn.211.i
push generator.for_each.gcn.211.array
pushai
@min.x
peek min.x
pop
...
generator.for_each.gcn.211.continue:
push generator.for_each.gcn.211.i
inc
pop
pushcp generator.for_each.gcn.211.start
jp
generator.for_each.gcn.211.end:
push min.r
jr
pushcp generator.if.gcn.207.end
jp
generator.if.gcn.207.else:
push null
jr
generator.if.gcn.207.end:
jr
min__end:
pushcp ord__end
jp
...
peek chr.r
pop
@generator.for_each.gcn.215.array
@generator.for_each.gcn.215.i
@generator.for_each.gcn.215.to
push chr.chars
peek generator.for_each.gcn.215.array
alen
peek generator.for_each.gcn.215.to
pop
pushc global.zero
peek generator.for_each.gcn.215.i
pop
generator.for_each.gcn.215.start:
pushcp generator.for_each.gcn.215.end
push generator.for_each.gcn.215.i
push generator.for_each.gcn.215.to
eq
not
jz
pop
push generator.for_each.gcn.215.i
push generator.for_each.gcn.215.array
pushai
@chr.ch
peek chr.ch
pop
...
add
pop
generator.for_each.gcn.215.continue:
push generator.for_each.gcn.215.i
inc
pop
pushcp generator.for_each.gcn.215.start
jp
generator.for_each.gcn.215.end:
push chr.r
jr
jr
chr__end:
...
invoke
jr
pushcp generator.switch.gcn.217.end
jp
...
pcopy
peek global.this
str generator.const.gcn.224 "Invalid type cast via str()."
...
push int.value
jr
pushcp generator.switch.gcn.225.end
jp
...
pcopy
peek global.this
str generator.const.gcn.233 "Invalid type cast via int()."
...
push real.value
jr
pushcp generator.switch.gcn.234.end
jp
...
pushc typereal
eq
pushcp generator.case.gcn.238.end
swp
jz
push real.value
jr
pushcp generator.switch.gcn.234.end
jp
generator.case.gcn.238.end:
pcopy
pushc typestr
eq
pushcp generator.case.gcn.239.end
swp
jz
push real.value
pushc s2f
...
pushcp generator.switch.gcn.234.end
jp
generator.case.gcn.239.end:
pushcp __allocator__exception
jc
pcopy
peek global.this
str generator.const.gcn.241 "Invalid type cast via int()."
...
peekai
pcopy
pushc cat__fakevoice
swp
pushcp vtable__fakevoice
swp
peekai
pcopy
pushc creature__create
