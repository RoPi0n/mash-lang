...
type
  TMashGeneratorSVM = class
    ...
    private
      ...
      procedure GenMethodEnd(Outp: TStringList; mname: string);
...
procedure TMashGeneratorSVM.GenMethodEnd(Outp: TStringList; mname: string);
begin
  Outp.Add('jr');
